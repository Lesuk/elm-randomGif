...
var _user$project$Styles$buttonRow = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'display', _1: 'flex'},
			{ctor: '_Tuple2', _0: 'flex-direction', _1: 'row'}
		]));
var _user$project$Styles$colors = {offBlack: '#333', offWhite: '#F5F5F5'};
var _user$project$Styles$buttonBackground = function (actionName) {
	var _p0 = actionName;
	if (_p0 === 'Start') {
		return _user$project$Styles$colors.offBlack;
	} else {
		return '';
	}
};
var _user$project$Styles$actionButton = function (actionName) {
	return _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'flex-grow', _1: '1'},
				{ctor: '_Tuple2', _0: 'min-width', _1: '50%'},
				{ctor: '_Tuple2', _0: 'font-size', _1: '1.2rem'},
				{ctor: '_Tuple2', _0: 'border', _1: 'none'},
				{ctor: '_Tuple2', _0: 'outline', _1: 'none'},
				{ctor: '_Tuple2', _0: 'padding', _1: '0.4rem'},
				{
				ctor: '_Tuple2',
				_0: 'background',
				_1: _user$project$Styles$buttonBackground(actionName)
			}
			]));
};
var _user$project$Styles$header = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'text-transform', _1: 'uppercase'},
			{ctor: '_Tuple2', _0: 'background', _1: _user$project$Styles$colors.offBlack},
			{ctor: '_Tuple2', _0: 'padding', _1: '0.5em 1rem'},
			{ctor: '_Tuple2', _0: 'font-size', _1: '1.2rem'},
			{ctor: '_Tuple2', _0: 'color', _1: '#f5f5f5'},
			{ctor: '_Tuple2', _0: 'letter-spacing', _1: '0.4rem'},
			{ctor: '_Tuple2', _0: 'text-align', _1: 'center'}
		]));
var _user$project$Styles$Colors = F2(
	function (a, b) {
		return {offBlack: a, offWhite: b};
	});
			...
			case 'HandleInputChange':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{topic: _p1, isFetching: true}),
					_1: _user$project$Main$getRandomGif(_p1)
				};
			case 'MorePlease':
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$HandleInputChange = function (a) {
